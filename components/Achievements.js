  ...
  render() {
    ...
    return (
      <div className="overflow-hidden">
        <h2 className="text-center font-bold text-large md:text-4xl text-gray-400 uppercase py-3 md:p-10 p-2"> Latest Achievements </h2>
        <Slider {...settings} classNam="">
         {fadeImages.map(data => (
           <div className="m-2 gap-2" key={data.caption}>
             <div className="m-1 pb-5 md:pb-10 md:m-5 bg-white rounded">
                <img className="object-scale-down overflow-hidden" src={`${data.url}`} />
                <p className="pl-2 text-sm md:text-2xl absolute md:bottom-10">By {data.caption}</p>
             </div>
